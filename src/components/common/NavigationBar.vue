<template>
  <nav
    class="flex fixed inset-x-0 bottom-0 flex-col justify-center items-center px-10 py-4 w-full text-base text-center whitespace-nowrap bg-white rounded-t-3xl shadow-lg"
  >
